...
import { selectIncreaseAmount, selectRandomGroups } from '../Redux/merchantSlice';
...
const Random = (props: any) => {
    ...
    const randomGroups = useAppSelector(selectRandomGroups);
    ...
    const buildRecipeCards = () => {
        return (
            <>
                {
                    randomGroups.map((group: any, id: number) => {
